...
@Configuration
class OpenAPIConfig(
    @Value("\${in2.openapi.server.url}") private val localUrl: String,
    ...
    fun myOpenAPI(): OpenAPI {
        ...
        val info: Info = Info()
            .title("IN2 Wallet Creation Application")
            .version("0.1")
            .contact(contact)
            .description("This API exposes endpoints to manage the IN2 Wallet Creation Application.")
